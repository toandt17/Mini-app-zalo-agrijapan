    ...
    <div class="main-container container-fluid">
        <div class="inner-body">
            ...
            <div class="page-header">
                <div>
                    <h2 class="main-content-title tx-24 mg-b-5">Thêm câu hỏi mới</h2>
                    <ol class="breadcrumb">
                            ...
                            <form action="{{ route('admin.questions.store') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="points_reward" id="points_reward" class="form-control @error('points_reward') is-invalid @enderror" value="{{ old('points_reward', 0) }}" min="0" required>
                                            @error('points_reward')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="spin_tickets" id="spin_tickets" class="form-control @error('spin_tickets') is-invalid @enderror" value="{{ old('spin_tickets', 0) }}" min="0" required>
                                            @error('spin_tickets')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group mt-4">
                                    <button type="submit" class="btn ripple btn-primary">
                                        <i class="fe fe-save"></i> Lưu câu hỏi
                                    </button>
                                </div>
                            </form>
                        </div>
