        ...
        <div class="main-header-left">
            ...
            <div class="hor-logo">
                <a class="main-logo" href="index.html">
                    <img src="{{ asset('assets/build/assets/img/logo/logo-agrijapan.png') }}" class="header-brand-img desktop-logo" alt="logo">
                    <img src="{{ asset('assets/build/assets/img/logo/logo-agrijapan.png') }}" class="header-brand-img desktop-logo-dark" alt="logo">
                </a>
            </div>
        </div>
        <div class="main-header-center">
            <div class="responsive-logo">
                <a href="index.html"><img src="{{ asset('assets/build/assets/img/logo/logo-agrijapan.png') }}" class="mobile-logo" alt="logo"></a>
                <a href="index.html"><img src="{{ asset('assets/build/assets/img/logo/logo-agrijapan.png') }}" class="mobile-logo-dark" alt="logo"></a>
            </div>
                                ...
                                <div class="main-notification-list">
                                    <div class="media new">
                                        <div class="main-img-user online">
                                            <img alt="avatar" src="build/assets/img/users/5.jpg">
                                        </div>
                                    ...
                                    <div class="media">
                                        <div class="main-img-user">
                                            <img alt="avatar" src="build/assets/img/users/2.jpg">
                                        </div>
                                        <div class="media-body">
                                            <a href="notifications-list.html">
                                    ...
                                    <div class="media">
                                        <div class="main-img-user">
                                            <img alt="avatar" src="build/assets/img/users/7.jpg">
                                        </div>
                                        <div class="media-body">
                                            <a href="notifications-list.html">
                                                <p>Project has been approved from <strong>Capital Tech</strong></p>
                                    ...
                                    <div class="media">
                                        <div class="main-img-user">
                                            <img alt="avatar" src="build/assets/img/users/9.jpg">
                                        </div>
                                        <div class="media-body">
                                            <a href="notifications-list.html">
                                                <p>New Appllication received from <strong>Fiona Grace.</strong></p>
                                    ...
                                    <div class="media">
                                        <div class="main-img-user online">
                                            <img alt="avatar" src="build/assets/img/users/3.jpg">
                                        </div>
                                        <div class="media-body">
                                            <a href="notifications-list.html">
                        ...
                        <div class="dropdown d-flex main-header-message">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="main-message-list">
                                    ...
                                    <div class="media">
                                        <div class="main-img-user">
                                            <img alt="avatar" src="build/assets/img/users/11.jpg">
                                        </div>
                                        <div class="media-body">
                                            <a href="chat.html">
                                    ...
                                    <div class="media">
                                        <div class="main-img-user">
                                            <img alt="avatar" src="build/assets/img/users/4.jpg">
                                        </div>
                                        <div class="media-body">
                                            <a href="chat.html">
                        ...
                        <div class="dropdown d-flex main-profile-menu">
                            <a class="d-flex" href="javascript:void(0);">
                                <span class="main-img-user">
                                    <img alt="avatar" src="build/assets/img/users/6.jpg">
                                </span>
                            </a>
                            <div class="dropdown-menu">
                                <div class="header-navheading">
                                ...
                                <form action="{{ route('admin.logout') }}" method="POST" id="logout-form">
                                    ...
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="document.getElementById('logout-form').submit();">
                                        <i class="fe fe-power"></i> Đăng xuất
                                    </a>
                                </form>
                            </div>
                        </div><!-- profile -->
